    ...
    public function saveData()
{
    ...
    $this->mainctrdao->saveGenerador($generadorFile);
 ...
 public function generar()
    {
        ...
        $this->mainctrdao->crearPorcentajePerfil($ofertaId, $GB);
        ...
        $this->mainctrdao->crearFacturacionCFESSB($ofertaId, $GB, $params);        
        /********************/
        /*FIN facturacion cfessb*/

        /********************/
        /*INICIO facturacion cfessb*/
        $this->mainctrdao->crearFacturacion1($ofertaId, $GB, $params);        
        /********************/
        /*FIN facturacion cfessb*/
