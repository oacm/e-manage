<div class="right_col" role="main">
 ...
 <button type="button" class="btn btn-lg btn-default" id="verhistorico" style="display:none;">
...
<div id="pending-doc" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
 ...
 <form id="excel-form" action="javascript:void(0);" method="post">
   ...
   <div class="form-group col-md-3">
      <label for="inputCentral">Tanque de Carga</label>
      <select id="inputCentral" class="form-control">
        ...
        if ($userData["WorkCenter"]==1 || count($verAdminWC)>0) {?>
             <option selected="TRUE"  value="0">Seleccione el tanque de carga...</option>
        <?php }
    ...
    <div class="form-group col-md-12">
        ...
        <div id="tablaexcelo" style="font-size: 10px; height: 46px; overflow: hidden;" data-initialstyle="font-size: 10px; " data-originalstyle="font-size: 10px; height: 114px; overflow: hidden;" class="handsontable htRowHeaders htColumnHeaders">
            <div class="ht_clone_top handsontable" style="position: absolute; top: 0px; left: 0px; overflow: hidden; width: 924px; height: 30px;">
                <div class="wtHolder" style="position: relative; width: 924px; height: 46px;">
                    <div class="wtHider" style="width: 924px;">
                        <div class="wtSpreader" style="position: relative; left: 0px;">
                            <table class="htCore">
                                <colgroup>
                                    <col class="rowHeader" style="width: 74px;">
