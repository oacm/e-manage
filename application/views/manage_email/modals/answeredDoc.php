<form class="form-horizontal form-label-left input_mask" action="javascript:void(0);" method="post">
    ...
    <div class="form-group">
        Pedir respuesta del documento<br><b class="folio-doc">Folio Doc</b>
    </div>

    <div class="form-group">
        <label class="control-label col-md-5 col-sm-2 col-xs-12">
            Pedir A <span class="required">*</span>
        </label>
        <div class="col-md-7 col-sm-10 col-xs-12">
            <select id="turned-employee" name="employee_id" class="select2_single form-control" required="required" tabindex="-1" style="width: 100%;"></select>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="control-label col-md-11 col-sm-11 col-xs-11">
            <select id="cc-answered" name="cc[]" multiple="true" class="select2_single form-control" tabindex="-1" style="width: 100%;"></select>
        </div>
    </div>
