function TableInbox(querySelector, extraConfig){
    ...
    this.viewerPanel  = new PanelForm("view-doc", extraConfig.formObj);
    this.formButtons  = extraConfig.formButtons;
    this.historyFolio = extraConfig.historyFolio ? extraConfig.historyFolio : false;
    ...
    this.loadAntecedents = function(_this){    
        ...
        antecedentsAjax.setData({documentId: _this.historyFolio ? data.control_folio_out : data.control_folio});
    ...
    this.setFilesData    = function (controlFolio){
        getFilesDataAjax.scope = this.parentObj.parentObj.parentObj;
    ...
    this.openViewer      = function (_this){
        ...
        _this.parentObj.parentObj.parentObj.showPanel(_this.viewerPanel.jQueryObj);
        _this.setView(_this.historyFolio ? data.control_folio_out : data.control_folio);
        _this.setFilesData(_this.historyFolio ? data.control_folio_out : data.control_folio);
        
        _this.viewerPanel.jQueryObj.find("[data-buttons]").css("display", "none");
        _this.viewerPanel.jQueryObj.find("[data-buttons='" + _this.formButtons + "']").css("display", "block");
...
TableInbox.prototype = new DataTableObj();